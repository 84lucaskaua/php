...
// Inserir no banco
$sql1 = "INSERT INTO somas (numero1, numero2, resultado) VALUES ($num1a, $num1b, $resultado1)";
$sql2 = "INSERT INTO somas (numero1, numero2, resultado) VALUES ($num2a, $num2b, $resultado2)";
$sql3 = "INSERT INTO somas (numero1, numero2, resultado) VALUES ($num3a, $num3b, $resultado3)";
...
// Consultar tabela
$consulta = $conexao->query("SELECT * FROM somas");
