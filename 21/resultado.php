...
<body>
    ...
    // Gravar no banco
    $sql = "INSERT INTO multiplicacoes_form (numero1, numero2, numero3, resultado) VALUES ($num1, $num2, $num3, $resultado)";
    $conexao->query($sql);
    ?>
    ...
    <div class="registros">
        ...
        <table border="1" cellpadding="8">
            ...
            <?php
            $consulta = $conexao->query("SELECT * FROM multiplicacoes_form");
